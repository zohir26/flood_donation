...
//     const cardDonationInput = document.getElementById("card-donation-input-3").value;
...
//     const cardWallet = document.getElementById("card-wallet-3").innerText;
//     const cardWalletBalance = parseFloat(cardWallet);
//     const cardNewBalance= (cardDonationBalance + cardWalletBalance);
   
//     const cardBalance= document.getElementById("card-wallet-3").innerText = cardNewBalance; 
